...
def split_api_documentation(api_file_path="docs/api.md", output_dir="wiki-content"):
    ...
    index_content.append("This is the comprehensive API reference for the FINN framework, generated automatically from source code.")
    index_content.append("")
    ...
    for module_name, filename in sorted(module_files):
        ...
        display_name = module_name.replace("finn.", "").replace("_", " ").title()
        index_content.append(f"- [{display_name}]({filename.replace('.md', '')})")
