...
def test_execute_onnx_invalid_input_name():
    """Test that execute_onnx raises FINNUserError for invalid input tensor names.
    ...
    # Invalid input name should raise FINNUserError with helpful message
    with pytest.raises(FINNUserError) as excinfo:
