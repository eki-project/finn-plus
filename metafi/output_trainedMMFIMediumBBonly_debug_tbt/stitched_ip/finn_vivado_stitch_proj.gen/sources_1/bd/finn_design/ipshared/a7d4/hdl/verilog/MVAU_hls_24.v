...
(* CORE_GENERATION_INFO="MVAU_hls_24_MVAU_hls_24,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.079750,HLS_SYN_LAT=4128776,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2722,HLS_SYN_LUT=2511,HLS_VERSION=2022_2}" *)
...
MVAU_hls_24_Matrix_Vector_Activate_Stream_Batch grp_Matrix_Vector_Activate_Stream_Batch_fu_60(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
