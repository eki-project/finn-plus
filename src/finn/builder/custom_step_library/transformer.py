...
def node_by_node_cppsim(model: ModelWrapper, cfg: DataflowBuildConfig):
    """
    Runs a node-by-node C++ simulation of the model saving the full execution context.

    Prepares the model for C++ simulation, executes it with verification inputs,
    and saves the complete execution context.
...
def node_by_node_rtlsim(model: ModelWrapper, cfg: DataflowBuildConfig):
    """
    Runs a node-by-node RTL simulation of the model saving the full execution context.

    Prepares the model for RTL simulation, synthesizes IP, executes it with
    verification inputs, and saves the complete execution context.
