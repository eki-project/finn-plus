...
def find_unused_ports(start: int, end: int, count: int, host: str = "127.0.0.1") -> list[int]:
...
def main() -> None:
    ...
    parser.add_argument("--host", type=str, default="127.0.0.1", help="Host/interface to test bind")
